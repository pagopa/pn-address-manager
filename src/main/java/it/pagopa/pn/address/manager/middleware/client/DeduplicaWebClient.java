...
@Component
public class DeduplicaWebClient extends CommonBaseClient {

    private final ResponseExchangeFilter responseExchangeFilter;
    private final PnAddressManagerConfig cfg;
    public DeduplicaWebClient(ResponseExchangeFilter responseExchangeFilter, PnAddressManagerConfig cfg) {
