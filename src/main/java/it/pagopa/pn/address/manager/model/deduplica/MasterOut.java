...
public class MasterOut {
	...
	private String id;
	private int nRisultatoNorm;
	private int nErroreNorm;
	...
	public int getnRisultatoNorm() {
		return nRisultatoNorm;
	}
	public void setnRisultatoNorm(int nRisultatoNorm) {
		this.nRisultatoNorm = nRisultatoNorm;
	}
	public int getnErroreNorm() {
		return nErroreNorm;
	}
	public void setnErroreNorm(int nErroreNorm) {
	...
	public String toString() {
		return "MasterOut [id=" + id + ", nRisultatoNorm=" + nRisultatoNorm + ", nErroreNorm=" + nErroreNorm
				+ ", sSiglaProv=" + sSiglaProv + ", fPostalizzabile=" + fPostalizzabile + ", sStatoUff=" + sStatoUff
				+ ", sStatoAbb=" + sStatoAbb + ", sStatoSpedizione=" + sStatoSpedizione + ", sComuneUff=" + sComuneUff
				+ ", sComuneAbb=" + sComuneAbb + ", sComuneSpedizione=" + sComuneSpedizione + ", sFrazioneUff="
				+ sFrazioneUff + ", sFrazioneAbb=" + sFrazioneAbb + ", sFrazioneSpedizione=" + sFrazioneSpedizione
				+ ", sCivicoAltro=" + sCivicoAltro + ", sCap=" + sCap + ", sPresso=" + sPresso + ", sViaCompletaUff="
				+ sViaCompletaUff + ", sViaCompletaAbb=" + sViaCompletaAbb + ", sViaCompletaSpedizione="
